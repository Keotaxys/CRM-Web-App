...
export default function ActivityDetailPage() {
  ...
  const currentLinkedCustomer = activity.id === id && linkedCustomer?.id === activity.customerId ? linkedCustomer : null;
