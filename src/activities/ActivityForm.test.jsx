...
describe('ActivityForm relationships', () => {
  ...
  it('validates the required Customer Meeting customer and submits the Laos datetime payload once the customer is selected', async () => {
    const user =
      userEvent.setup();
  ...
  it('shows all Customer Meeting fields in natural Lao', () => {
    ...
    expect(
      screen.queryByText(
        /Visit Purpose|Product \/ Service|Pre-visit|Visit Notes|Result|Follow-up/,
      ),
    ).not.toBeInTheDocument();
  });
});